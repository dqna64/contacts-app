...
function UserCard({ template, data }) {
  return (
    <div className="border border-gray-400 px-3 lg:px-6 py-3 lg:py-5 bg-slate-100">
      <div className="text-xl lg:text-2xl font-bold leading-6 lg:leading-6 border-b border-gray-300 pb-[2px] lg:pb-[4px]">
        ...
        <SkeletonCircle/><div className='ml-4 grow'><SkeletonText noOfLines={1} /></div>
        </div>
        ) : (
          <>
            <span>{data.name}</span>
